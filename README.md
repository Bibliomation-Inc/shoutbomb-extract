...
- Action trigger templates: see [extras/README.md](extras/README.md) for Evergreen action trigger setup notes, including the production Hold Ready Notice template used at Bibliomation.
...
📁 docs/
    ├── 📄 renewal-eligibility.md            # Explanation of renewal eligibility logic
📁 extras/
    ├── 🗃️ courtesy_at_template.tt2          # Courtesy Notice action trigger template (WIP; not in use at Bibliomation)
    ├── 🗃️ test_sms_at_template.tt2          # Template for Test SMS action trigger
    ├── 🗃️ send_call_number_at_template.tt2  # Template for Call Number action trigger
    ├── 🗃️ hold_ready_at_template.tt2        # Template for Hold Ready Notice action trigger
    └── 📄 README.md                         # Documentation for extras
📁 lib/                          # Perl modules
    ├── 🐪 DBUtils.pm            # Database utilities
    ├── 🐪 Email.pm              # Email functions
    ├── 🐪 SFTP.pm               # SFTP transfer functions
    ├── 🐪 Logging.pm            # Logging functions
    └── 🐪 Utils.pm              # Miscellaneous utilities
📁 sql/                          # SQL query files
...
1. Clone the repository:
    ```bash
    git clone https://github.com/Bibliomation-Inc/shoutbomb-extract.git
...
### Action Trigger Templates for Shoutbomb SMS
